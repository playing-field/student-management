package lk.ijse.dep.web.stm.util;
...
public class JPAUtil {
    ...
    private static EntityManagerFactory emf = buildEntityMangerFactory();
    ...
    public static DataSource getDataSource(){
        ...
        bds.setUsername(properties.getProperty("dbcp.jdbc.username"));
